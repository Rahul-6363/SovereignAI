...
export default function TrustDrawer({
  ...
  return (
    ...
    >
      <div
        className="flex h-full w-[420px] animate-slide-in-right flex-col border-l border-ink-800 bg-ink-900 shadow-pop"
      ...
      >
        ...
        <div className="border-b border-ink-800 px-4 py-2">
          <SegmentedControl
            ...
            value={tab}
            onChange={setTab}
            ariaLabel="Trust centre section"
            options={[
